...
| -A n | แสดงบรรทัดที่ตรงกับเงื่อนไขพร้อมบรรทัดหลัง |
| -B n | แสดงบรรทัดที่ตรงกับเงื่อนไขพร้อมบรรทัดก่อน |
| -C n | แสดงบรรทัดที่ตรงกับเงื่อนไขพร้อมบรรทัดที่อยู่ก่อน |
...
vi [options] [file]
```
* 7.1 ตัวอย่างคำสั่งที่ใช้ในการสร้างไฟล์:
  ```
  $ $ vi test.txt
  ```
* 7.2 เขียนหรือแทรกข้อมูลลง file
  #### Option มีดังนี้:
| Option | Description |
| :----: | ----------- |
